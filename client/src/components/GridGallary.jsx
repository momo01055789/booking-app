...
const GridGallary = ({ place }) => {
        ...
        <div className="p-8 grid  gap-4 bg-black">
          <div>
            <button
              ...
              className="fixed flex gap-1 py-2 px-4 rounded-2xl bg-white "
            >
              <svg
  ...
  return (
    <div className="relative">
      ...
      <button
        onClick={() => setShowAllPhotos(true)}
        className="flex gap-1 absolute bottom-2 right-2 px-2 py-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
